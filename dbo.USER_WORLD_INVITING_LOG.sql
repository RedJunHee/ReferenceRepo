...
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'초대자 월드 초대 코드.' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'USER_WORLD_INVITING_LOG', @level2type=N'COLUMN',@level2name=N'WORLD_USER_CODE';
