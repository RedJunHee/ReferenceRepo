...
CREATE NONCLUSTERED INDEX [NC2_INVITING_LOG_COL_SUID_WORLD] ON USER_WORLD_INVITING_LOG (TARGET_SUID, USER_SUID, WORLD_ID) WITH FILLFACTOR = 90 ON [PRIMARY]

-- 알림 조회에서 12주 알림 필터링.
CREATE CLUSTERED INDEX FK_USER_WORLD_INVITING_LOG_COL_CREATEDT ON USER_WORLD_INVITING_LOG (CREATE_DT ASC) WITH FILLFACTOR = 90 ON [PRIMARY]
...
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'SEQ 로그 ID' , @level0type=N'SCHEMA',@level0name=N'dbo', 
@level1type=N'TABLE', @level1name=N'USER_WORLD_INVITING_LOG', @level2type=N'COLUMN',@level2name=N'SEQ';

EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'초대 대상자 SUID' , @level0type=N'SCHEMA',@level0name=N'dbo', 
@level1type=N'TABLE', @level1name=N'USER_WORLD_INVITING_LOG', @level2type=N'COLUMN',@level2name=N'TARGET_SUID';
...
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'초대 수락, 거절 날짜.' , @level0type=N'SCHEMA', @level0name=N'dbo', 
@level1type=N'TABLE', @level1name=N'USER_WORLD_INVITING_LOG', @level2type=N'COLUMN',@level2name=N'UPDATE_DT';
...
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'초대자 월드 초대 코드.' , @level0type=N'SCHEMA', @level0name=N'dbo', 
@level1type=N'TABLE', @level1name=N'USER_WORLD_INVITING_LOG', @level2type=N'COLUMN',@level2name=N'WORLD_USER_CODE';
